...
require_once($CFG->dirroot . '/course/format/gridiron/lib.php'); // For format_grid.
...
$filepath = $CFG->dirroot . '/course/format/gridiron/test/' . $imagefilename;
...
$src = $CFG->wwwroot . '/course/format/gridiron/test/' . $imagefilename;
