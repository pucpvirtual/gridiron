...
class format_gridiron extends format_base {
   ...
   /**
    ...
    public function get_section_name($section) {
        ...
        if (!empty($section->name)) {
            ...
            return get_string('topic0', 'format_gridiron');
        } else {
            return get_string('topic', 'format_gridiron') . ' ' . $section->section;
        }
    }
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($courseformatoptions === false) {
            ...
            $defaultbordercolour = get_config('format_gridiron', 'defaultbordercolour');
            if ($defaultbordercolour[0] == '#') {
                $defaultbordercolour = substr($defaultbordercolour, 1);
            }
            $defaultimagecontainerbackgroundcolour = get_config('format_gridiron', 'defaultimagecontainerbackgroundcolour');
            ...
            $defaultcurrentselectedsectioncolour = get_config('format_gridiron', 'defaultcurrentselectedsectioncolour');
            if ($defaultcurrentselectedsectioncolour[0] == '#') {
                $defaultcurrentselectedsectioncolour = substr($defaultcurrentselectedsectioncolour, 1);
            }
            $defaultcurrentselectedimagecontainercolour = get_config('format_gridiron', 'defaultcurrentselectedimagecontainercolour');
            ...
            $courseformatoptions = array(
                ...
                'extraelements' => array(
                    'default' => get_config('gridiron', 'extraelements'),
                    'type' => PARAM_INT,
                ),
                'imagecontainerwidth' => array(
                    'default' => get_config('format_gridiron', 'defaultimagecontainerwidth'),
                    'type' => PARAM_INT
                ),
                'imagecontainerratio' => array(
                    'default' => get_config('format_gridiron', 'defaultimagecontainerratio'),
                    'type' => PARAM_ALPHANUM
                ),
                'imageresizemethod' => array(
                    'default' => get_config('format_gridiron', 'defaultimageresizemethod'),
                    'type' => PARAM_INT
                ),
                'bordercolour' => array(
                ...
                'borderwidth' => array(
                    'default' => get_config('format_gridiron', 'defaultborderwidth'),
                    'type' => PARAM_INT
                ),
                'borderradius' => array(
                    'default' => get_config('format_gridiron', 'defaultborderradius'),
                    'type' => PARAM_INT
                ),
                ...
                'newactivity' => array(
                    'default' => get_config('format_gridiron', 'defaultnewactivity'),
                    'type' => PARAM_INT
                )
            );
        }
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            ...
            $courseformatoptionsedit = array(
                'numsections' => array(
                    'label' => new lang_string('numbersections', 'format_gridiron'),
                    'element_type' => 'select',
            ...
            if (has_capability('format/grid:changeimagecontainersize', $coursecontext)) {
                  ...
                  $courseformatoptionsedit['extraelements'] = array(
                    'label' => new lang_string('setextraelements', 'format_gridiron'),
                    'help' => 'setextraelements',
                    'help_component' => 'format_gridiron',
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(1 => new lang_string('setnotice', 'format_gridiron'),                            
                              2 => new lang_string('setprofile', 'format_gridiron'),          
                              3 => new lang_string('setnotice_profile', 'format_gridiron'),          
                              4 => new lang_string('set_noelements', 'format_gridiron'))
                    )
                );

                $courseformatoptionsedit['imagecontainerwidth'] = array(
                    'label' => new lang_string('setimagecontainerwidth', 'format_gridiron'),
                ...
                $courseformatoptionsedit['imagecontainerratio'] = array(
                    'label' => new lang_string('setimagecontainerratio', 'format_gridiron'),
                ...
                $courseformatoptionsedit['imagecontainerwidth'] = array('label' => 
                    get_config('format_gridiron', 'defaultimagecontainerwidth'), 'element_type' => 'hidden');
                $courseformatoptionsedit['imagecontainerratio'] = array('label' => 
                    get_config('format_gridiron', 'defaultimagecontainerratio'), 'element_type' => 'hidden');
            }

            if (has_capability('format/grid:changeimageresizemethod', $coursecontext)) {
                $courseformatoptionsedit['imageresizemethod'] = array(
                    'label' => new lang_string('setimageresizemethod', 'format_gridiron'),
                ...
                $courseformatoptionsedit['imageresizemethod'] = array('label' =>
                    get_config('format_gridiron', 'defaultimageresizemethod'), 'element_type' => 'hidden');
            }

            if (has_capability('format/grid:changeimagecontainerstyle', $coursecontext)) {
                $courseformatoptionsedit['bordercolour'] = array(
                    'label' => new lang_string('setbordercolour', 'format_gridiron'),
                    'help' => 'setbordercolour',
                    'help_component' => 'format_gridiron',
                    'element_type' => 'gfcolourpopup',
                    'element_attributes' => array(
                        array('tabindex' => -1, 'value' => get_config('format_gridiron', 'defaultbordercolour'))
                    )
                );

                $courseformatoptionsedit['borderwidth'] = array(
                    'label' => new lang_string('setborderwidth', 'format_gridiron'),
                    'help' => 'setborderwidth',
                    'help_component' => 'format_gridiron',
                    'element_type' => 'select',
                ...
                $courseformatoptionsedit['borderradius'] = array(
                    'label' => new lang_string('setborderradius', 'format_gridiron'),
                    'help' => 'setborderradius',
                    'help_component' => 'format_gridiron',
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(1 => new lang_string('off', 'format_gridiron'),
                            2 => new lang_string('on', 'format_gridiron'))
                    )
                );

                $courseformatoptionsedit['imagecontainerbackgroundcolour'] = array(
                    'label' => new lang_string('setimagecontainerbackgroundcolour', 'format_gridiron'),
                    'help' => 'setimagecontainerbackgroundcolour',
                    'help_component' => 'format_gridiron',
                    'element_type' => 'gfcolourpopup',
                    'element_attributes' => array(
                        array('tabindex' => -1, 'value' => get_config('format_gridiron', 'defaultimagecontainerbackgroundcolour'))
                    )
                );

                $courseformatoptionsedit['currentselectedsectioncolour'] = array(
                    'label' => new lang_string('setcurrentselectedsectioncolour', 'format_gridiron'),
                    'help' => 'setcurrentselectedsectioncolour',
                    'help_component' => 'format_gridiron',
                    'element_type' => 'gfcolourpopup',
                    'element_attributes' => array(
                        array('tabindex' => -1, 'value' => get_config('format_gridiron', 'defaultcurrentselectedsectioncolour'))
                    )
                );

                $courseformatoptionsedit['currentselectedimagecontainercolour'] = array(
                    'label' => new lang_string('setcurrentselectedimagecontainercolour', 'format_gridiron'),
                    'help' => 'setcurrentselectedimagecontainercolour',
                    'help_component' => 'format_gridiron',
                    'element_type' => 'gfcolourpopup',
                    'element_attributes' => array(
                        array('tabindex' => -1, 'value' => get_config('format_gridiron', 'defaultcurrentselectedimagecontainercolour'))
                    )
                );
            } else {
                $courseformatoptionsedit['bordercolour'] = array('label' => $defaultbordercolour,
                    'element_type' => 'hidden');
                $courseformatoptionsedit['borderwidth'] = array('label' => get_config('format_gridiron', 'defaultborderwidth'),
                    'element_type' => 'hidden');
                $courseformatoptionsedit['borderradius'] = array('label' => get_config('format_gridiron', 'defaultborderradius'),
                    'element_type' => 'hidden');
            ...
            $courseformatoptionsedit['newactivity'] = array(
                'label' => new lang_string('setnewactivity', 'format_gridiron'),
                'element_type' => 'select',
                'element_attributes' => array(
                    array(
    ...
    public function create_edit_form_elements(&$mform, $forsection = false) {
        global $CFG, $OUTPUT;
        MoodleQuickForm::registerElementType('gfcolourpopup', "$CFG->dirroot/course/format/gridiron/js/gf_colourpopup.php",
        ...
        if ($forsection == false) {
            ...
            $elements[] = $mform->addElement('header', 'gfreset', get_string('gfreset', 'format_gridiron'));
            $mform->addHelpButton('gfreset', 'gfreset', 'format_gridiron', '', true);
            ...
            if ((($changeimagecontainersize) || ($changeimageresizemethod) || ($changeimagecontainerstyle))) {
                ...
                if ($changeimagecontainersize) {
                    $checkboxname = get_string('resetimagecontainersize', 'format_gridiron') .
                            $OUTPUT->help_icon('resetimagecontainersize', 'format_gridiron');
                    $resetelements[] = & $mform->createElement('checkbox', 'resetimagecontainersize', '', $checkboxname);
                }

                if ($changeimageresizemethod) {
                    $checkboxname = get_string('resetimageresizemethod', 'format_gridiron') .
                            $OUTPUT->help_icon('resetimageresizemethod', 'format_gridiron');
                    $resetelements[] = & $mform->createElement('checkbox', 'resetimageresizemethod', '', $checkboxname);
                }

                if ($changeimagecontainerstyle) {
                    $checkboxname = get_string('resetimagecontainerstyle', 'format_gridiron') .
                            $OUTPUT->help_icon('resetimagecontainerstyle', 'format_gridiron');
                    $resetelements[] = & $mform->createElement('checkbox', 'resetimagecontainerstyle', '', $checkboxname);
                }
            }

            $checkboxname = get_string('resetnewactivity', 'format_gridiron') .
                $OUTPUT->help_icon('resetnewactivity', 'format_gridiron');
            $resetelements[] = & $mform->createElement('checkbox', 'resetnewactivity', '', $checkboxname);

            $elements[] = $mform->addGroup($resetelements, 'resetgroup', get_string('resetgrp', 'format_gridiron'), null,
                false);

            if ($resetall) {
                $resetallelements = array();

                $checkboxname = get_string('resetallimagecontainersize', 'format_gridiron') .
                    $OUTPUT->help_icon('resetallimagecontainersize', 'format_gridiron');
                $resetallelements[] = & $mform->createElement('checkbox', 'resetallimagecontainersize', '', $checkboxname);

                $checkboxname = get_string('resetallimageresizemethod', 'format_gridiron') .
                    $OUTPUT->help_icon('resetallimageresizemethod', 'format_gridiron');
                $resetallelements[] = & $mform->createElement('checkbox', 'resetallimageresizemethod', '', $checkboxname);

                $checkboxname = get_string('resetallimagecontainerstyle', 'format_gridiron') .
                    $OUTPUT->help_icon('resetallimagecontainerstyle', 'format_gridiron');
                $resetallelements[] = & $mform->createElement('checkbox', 'resetallimagecontainerstyle', '', $checkboxname);

                $checkboxname = get_string('resetallnewactivity', 'format_gridiron') .
                    $OUTPUT->help_icon('resetallnewactivity', 'format_gridiron');
                $resetallelements[] = & $mform->createElement('checkbox', 'resetallnewactivity', '', $checkboxname);

                $elements[] = $mform->addGroup($resetallelements, 'resetallgroup', get_string('resetallgrp', 'format_gridiron'),
                    null, false);
            }
        }
    ...
    public function edit_form_validation($data, $files, $errors) {
        ...
        if ($this->validate_colour($data['bordercolour']) === false) {
            $retr['bordercolour'] = get_string('colourrule', 'format_gridiron');
        }
        if ($this->validate_colour($data['imagecontainerbackgroundcolour']) === false) {
            $retr['imagecontainerbackgroundcolour'] = get_string('colourrule', 'format_gridiron');
        }
        if ($this->validate_colour($data['currentselectedsectioncolour']) === false) {
            $retr['currentselectedsectioncolour'] = get_string('colourrule', 'format_gridiron');
        }
        if ($this->validate_colour($data['currentselectedimagecontainercolour']) === false) {
            $retr['currentselectedimagecontainercolour'] = get_string('colourrule', 'format_gridiron');
        }
    ...
    public function reset_grid_setting($courseid, $imagecontainersizereset, $imageresizemethodreset, $imagecontainerstylereset, $newactivityreset) {
        ...
        if ($imagecontainersizereset && has_capability('format/grid:changeimagecontainersize', $coursecontext) && $resetallifall) {
            $updatedata['imagecontainerwidth'] = get_config('format_gridiron', 'defaultimagecontainerwidth');
            $updatedata['imagecontainerratio'] = get_config('format_gridiron', 'defaultimagecontainerratio');
        ...
        if ($imageresizemethodreset && has_capability('format/grid:changeimageresizemethod', $coursecontext) && $resetallifall) {
            $updatedata['imageresizemethod'] = get_config('format_gridiron', 'defaultimageresizemethod');
        ...
        if ($imagecontainerstylereset && has_capability('format/grid:changeimagecontainerstyle', $coursecontext) && $resetallifall) {
            $updatedata['bordercolour'] = get_config('format_gridiron', 'defaultbordercolour');
            $updatedata['borderwidth'] = get_config('format_gridiron', 'defaultborderwidth');
            $updatedata['borderradius'] = get_config('format_gridiron', 'defaultborderradius');
            $updatedata['imagecontainerbackgroundcolour'] = get_config('format_gridiron', 'defaultimagecontainerbackgroundcolour');
            $updatedata['currentselectedsectioncolour'] = get_config('format_gridiron', 'defaultcurrentselectedsectioncolour');
            $updatedata['currentselectedimagecontainercolour'] = get_config('format_gridiron',
                    'defaultcurrentselectedimagecontainercolour');
            $updateimagecontainerstyle = true;
        }
        if ($newactivityreset && $resetallifall) {
            $updatedata['newactivity'] = get_config('format_gridiron', 'defaultnewactivity');
    ...
    public function grid_moodle_url($url, array $params = null) {
        return new moodle_url('/course/format/gridiron/' . $url, $params);
    }
    ...
    public function get_image($courseid, $sectionid) {
        ...
        if (!$sectionimage = $DB->get_record('format_grid_icon', array('sectionid' => $sectionid))) {
            ...
            if (!$newimagecontainer->id = $DB->insert_record('format_grid_icon', $newimagecontainer, true)) {
                throw new moodle_exception('invalidrecordid', 'format_gridiron', '',
    ...
    public function create_section_image($tempfile, $storedfilerecord, $sectionimage) {
        ...
        try {
            ...
            if ($convertsuccess == true) {
                ...
                print_error('imagecannotbeused', 'format_gridiron', $CFG->wwwroot . "/course/view.php?id=" . $this->courseid);
            }
        } catch (Exception $e) {
            if (isset($tempfile)) {
                $tempfile->delete();
        ...
        try {
            ...
            if ($imagecontainerpathfile = $fs->get_file($contextid, 'course', 'section', $sectionimage->sectionid, '/',
                ...
                if ($convertsuccess == true) {
                    ...
                    print_error('cannotconvertuploadedimagetodisplayedimage', 'format_gridiron',
                            $CFG->wwwroot . "/course/view.php?id=" . $this->courseid);
                }
            } else {
                print_error('cannotfinduploadedimage', 'format_gridiron', $CFG->wwwroot . "/course/view.php?id=" . $this->courseid);
            }
        } catch (Exception $e) {
    ...
    private function update_displayed_images($courseid, $us, $settings, $ignorenorecords) {
        ...
        if (is_array($sectionimages)) {
            ...
            print_error('cannotgetimagesforcourse', 'format_gridiron', '', null, "update_displayed_images - Course id: " . $courseid);
        }
    }
 ...
 * @return bool Returns true
 */
function callback_gridiron_uses_sections() {
    return true;
}
 ...
 * @return bool Returns true
 */
function callback_gridiron_load_content(&$navigation, $course, $coursenode) {
 ...
 * @return string
 */
function callback_gridiron_definition() {
    return get_string('topic', 'format_gridiron');
}

/**
 * Deletes the settings entry for the given course upon course deletion.
 */
function format_gridiron_delete_course($courseid) {
    global $DB;
